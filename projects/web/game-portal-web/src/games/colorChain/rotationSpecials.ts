...
export function getRotationMatchRewards(
  ...
  // Prism Break is the top-priority reward. When its demanding
  // horizontal + vertical + diagonal condition is met, no other reward
  // may be generated by the same clear.
